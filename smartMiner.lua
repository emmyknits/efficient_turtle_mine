...
local function mineInDirectionIfNotTrash(mineDirection)
	...
	if mineDirection == EMineDirection.Forward then 
		if turtle.detect() then
    		...
    		return mineInDirectionIfNotTrash(mineDirection)
		else
			turtle.forward()
		end
	end
	...
	while not isRowFinished do
		...
		for i = pointAlongRowToReturnTo, distance do
			...
			for mineDirection = recentMinedDirection, EMineDirection.Above do
				if mineInDirectionIfNotTrash(mineDirection) == EMineAttemptResult.NoRoom then
